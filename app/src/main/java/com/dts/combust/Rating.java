...
public class Rating  extends PBase {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        addlog("Rating",""+du.getActDateTime(),gl.nombreusuario);
    ...
    public void GuardaRating(View view) {
        ...
        try{
            ...
            Integer pipa = gl.pipa;
            Integer vendedor=gl.userid;
            String idtranserror = idtranse;
            String fecha = du.univfechaextlong();
            ...
            if(gl.rolid==3) pipa=0;
            ins.add("PIPA", pipa);
            ins.add("USUARIO",vendedor);
    ...
    private void fillSpinner(){
        ...
        try {
            ...
            sql="SELECT IDTRANSERROR,TRANSERROR FROM TRANSERROR ORDER BY TRANSERROR";
